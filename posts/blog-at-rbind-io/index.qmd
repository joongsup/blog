...
So this weekend, I jumpted the gun and created an issue on rbind support github, which is what one needs to do to request for an rbind.io subdomain. To my pleasant surprise, @road2stat responded to my request quickly, and less than 24 hours later, the new blog address is joongsup.rbind.io :) (~~I wonder if there's a way to automatically redirect the visit to the original netlify address to the new rbind.io one?~~ And there's a way to do it. See [here](https://yihui.name/en/2017/11/301-redirect/).)
